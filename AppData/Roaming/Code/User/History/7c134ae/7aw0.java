public class ClassWork03062023 {
        public static void main(String[] args){
            ...
            //equals()
            String str4 = "Monkey";
            String str5 = new String("D.Luffy");
            ...
            String str6 = "Jacksonville State University";
            System.out.println(str6.substring(0,12));
            ...
            //String startWith()
            System.out.println(str6.startsWith("Jack"));

            //StringBuilder Methods
            //reverse()
            StringBuilder sBuilder2 = new StringBuilder("Mr.Willis");
            System.out.println(sBuilder2.reverse());

            //setcharAt()
            sBuilder2.setCharAt(1, 'W');
            System.out.println(sBuilder2);


            //delete()
            sBuilder2.delete(0, 3);
    }

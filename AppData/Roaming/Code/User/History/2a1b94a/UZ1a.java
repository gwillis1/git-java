...
public class TestWedding {
    public static void main(String[] args) {
        ...
        System.out.println("The Location will be: " + wedding1.getLocation());
        System.out.println("First Person: " + wedding1.getCouple().getFirstPerson().getFname() + " " + wedding1.getCouple().getFirstPerson().getLname());
        System.out.println("Second Person: " + wedding1.getCouple().getSecondPerson().getFname() + " " + wedding1.getCouple().getSecondPerson().getLname());
    }
}

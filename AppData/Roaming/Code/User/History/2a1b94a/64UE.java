...
public class TestWedding {
    public static void main(String[] args) {
        ...
        System.out.println("The Groom is : " + wedding1.getCouple().getFirstPerson().getFname() + " " + wedding1.getCouple().getFirstPerson().getLname() + " " + "Date of Birth: " + wedding1.getCouple().getFirstPerson().getBirthDate());
        System.out.println("The Bride is: " + wedding1.getCouple().getSecondPerson().getFname() + " " + wedding1.getCouple().getSecondPerson().getLname() + " " + "Date of Birth: " + wedding1.getCouple().getSecondPerson().getBirthDate());
    }
}

...
public class Group_6project {
    ...
    public static void main(String[] args) {
        ...
        while (sectionChoice != 4) {
            ...
            System.out.println("This section will cover the potential risks associated with online chatting and messaging and how to stay safe while communicating online.");
            System.out.println("---------------------------------------------------------------");
            ...
            System.out.println("4.A Quiz related to each topic ");
            System.out.println("5.A list of online resources that access to learn about each topic ");

            System.out.print("Enter the section number you wish to explore: ");
            ...
            switch (sectionChoice) {
                case 1:
                    ...
                    System.out.println("- Safe online chatting and messaging.");
                    System.out.println("- Theres no denying that our childrens lives are impacted by the online world.");
            ...
            switch (sectionChoice) {
                case 2:
                    ...
                    System.out.println("- Certainly, First thing General privacy was a primary issue that fail consideration of what information ");
                    System.out.println("- that handing over online to questionable websites and individuals. Even the contents of private communications arent safe.");
                    System.out.println("- The largest tech companies have admitted to scamming emails and messages.");
                    System.out.println("- platforms that might cause danger to children nowadays.");

                    System.out.println("- Secondly, there isn't just offline bullying their cyberbullying. ");
                    ...
                    System.out.println("- Thirdly On the other hand, The immediate risk was online predators that can easily take advantage of children online.");

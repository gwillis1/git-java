     ...
     */
     ...
     public static void main(String[] args){
        try {
            ...
            Scanner inputFile = new Scanner(new File("ClassWork03172023.txt"));
            PrintStream ps = new PrintStream(new File("ClassWork03172023_out.txt"));
            ...
            System.out.println("Data written to ClassWork03172023_out.txt");
